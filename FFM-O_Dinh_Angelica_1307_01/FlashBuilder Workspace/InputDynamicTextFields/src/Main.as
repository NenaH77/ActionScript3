...
package
{
	...
	public class Main extends Sprite
	{
		public function Main()
		{
			...
			name1Input.type = TextFieldType.INPUT;//allows you to add text in the textfield
			name1Input.defaultTextFormat = format;//allows you to format text in the textfield
			name1Input.maxChars = 4;//limits number of characters
			//the restrict
			name1Input.restrict = "0-9";//type in the allowed characters, a-z A-Z 0-9. , 
